<?php
    ...
    $sql = "UPDATE info SET lastname='rand' WHERE id=1";

    if (isset($_POST['submit'])){
        $edit = $conn->prepare("UPDATE info SET firstname=:firstname,lastname=:lastname WHERE Id = :Id");
        $edit->bindValue(':Id', $_POST['Id']);
        $edit->bindValue(':firstname', $_POST['firstname']);
        $edit->bindValue(':lastname',$_POST['lastname']);
        $edit->execute();
...
<body>
    ...
    <table>
        <thead>
                ...
                <tr>
                    ...
                    <td>
                    <a href="update.php?id=<?php echo $items['Id']?>" type="button">Update</a>
                    </td>
                </tr>
    ...
    <form>
        <input type="text"  value="<?php echo $firstname ?>" name="firstname"><br><br>
